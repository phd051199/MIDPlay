...
public final class SearchScreen extends BaseForm {
  ...
  public SearchScreen(Navigator navigator) {
    super(Lang.tr("menu.search"), navigator);
  ...
  private void search() {
    ...
    if (searchType.equals(Configuration.SearchType.TRACK)) {
      MIDPlay.startOperation(
          new SearchTrackOperation(
              keyword,
              new SearchTrackOperation.Listener() {
      ...
      MIDPlay.startOperation(
          new SearchPlaylistOperation(
              keyword,
              searchType,
              new SearchPlaylistOperation.Listener() {
