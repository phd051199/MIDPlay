...
public class Lang {
  ...
  private static final String[] KEYS = {
    ...
    "media.album", "media.playlist", "media.track", "menu.discover_playlists", "menu.favorites", "menu.now_playing", "menu.reorder", "menu.search", "menu.settings", "menu.about",
    "menu.visibility", "player.next", "player.play", "player.previous", "player.repeat", "player.show_playlist", "player.shuffle", "player.status.loading", "player.status.paused", "player.status.playing",
    "player.status.starting", "player.status.stopped", "player.status.stopping", "player.status.finished", "player.status.ready", "player.stop", "player.volume", "details.title", "details.name", "details.type",
    "details.custom", "details.system", "details.track_count", "details.artist", "details.duration", "details.url", "details.unknown_artist", "details.unknown_duration", "details.no_url", "playlist.add_track",
    "playlist.create", "playlist.confirm.delete_with_tracks", "playlist.view_tracks", "playlist.error.add_track_failed", "playlist.error.track_already_exists", "playlist.error.cannot_rename_system", "playlist.error.create_failed", "playlist.error.empty_name", "playlist.error.remove_track_failed", "playlist.error.rename_failed",
    "playlist.name", "playlist.rename", "playlist.select", "playlist.status.created", "playlist.status.no_custom", "playlist.status.renamed", "playlist.status.track_added", "playlist.status.track_removed", "search.error.empty_keyword", "search.placeholder",
    "search.results", "search.status.no_results", "search.status.searching", "search.type", "session.resume_prompt", "settings.audio_quality", "settings.auto_update", "settings.check_update", "settings.theme_mode", "settings.theme_color",
    "settings.use_wifi", "settings.theme_mode_options.dark", "settings.theme_mode_options.light", "settings.player_method", "settings.player_method_options.pass_inputstream", "settings.player_method_options.pass_url", "settings.error.save_failed", "settings.error.save_theme", "settings.error.load_theme", "settings.error.color_update_failed",
    ...
    "timer.confirm.exit", "timer.set", "timer.sleep_timer", "timer.status.cancelled", "timer.status.expired", "timer.status.set"
  };
  ...
  private static final String[] EN_VALS = {
    ...
    "Now Playing", "Reorder Menu", "Search", "Settings", "About",
    ...
    "Search Results", "No results found", "Searching for: {0}", "Search Type", "Resume your last session?",
    ...
    "Pass URL", "Failed to save settings", "Error saving theme: {0}", "Error loading theme: {0}", "Theme color update failed. Theme mode was saved.",
  ...
  private static final String[] HE_VALS = {
    ...
    "מושמע כעת", "סדר תפריט", "חיפוש", "הגדרות", "אודות",
    ...
    "תוצאות חיפוש", "לא נמצאו תוצאות", "מחפש: {0}", "סוג חיפוש", "להמשיך את ההפעלה האחרונה?",
    "איכות שמע", "עדכון אוטומטי", "בדוק עדכונים זמינים", "ערכת נושא", "צבע ערכת הנושא",
    "Use Wi-Fi", "כהה", "בהיר", "שיטת נגינה", "העבר Input Stream",
    "העבר URL", "שמירת ההגדרות נכשלה", "Error saving theme: {0}", "Error loading theme: {0}", "Theme color update failed. Theme mode was saved.",
  ...
  private static final String[] PL_VALS = {
    ...
    "Teraz odtwarzane", "Przestaw menu", "Wyszukaj", "Ustawienia", "Więcej informacji",
    ...
    "Wyniki wyszukiwania", "Nic nie znaleziono", "Szukanie: {0}", "Typ wyszukiwania", "Wznowić ostatnią sesję?",
    ...
    "Przekaż URL", "Nie udało się załadować ustawień", "Error saving theme: {0}", "Error loading theme: {0}", "Theme color update failed. Theme mode was saved.",
  ...
  private static final String[] TR_VALS = {
    ...
    "Şimdi Çalıyor", "Menüyü Yeniden Sırala", "Arama", "Ayarlar", "Hakkında",
    ...
    "Arama Sonuçları", "Sonuç bulunamadı", "Aranan: {0}", "Arama Türü", "Son oturumunuza devam edilsin mi?",
    ...
    "URL Geçir", "Ayarlar kaydedilemedi", "Error saving theme: {0}", "Error loading theme: {0}", "Theme color update failed. Theme mode was saved.",
    ...
    "Uyku zamanlayıcısı etkinleştirildi"
  };
  ...
  private static final String[] VI_VALS = {
    ...
    "Đang phát", "Sắp xếp menu", "Tìm kiếm", "Cài đặt", "Giới thiệu",
    ...
    "Kết quả tìm kiếm", "Không tìm thấy kết quả", "Đang tìm: {0}", "Loại tìm kiếm", "Tiếp tục phiên nghe gần nhất?",
    ...
    "Truyền URL", "Lỗi lưu cài đặt", "Lỗi lưu chủ đề: {0}", "Lỗi tải chủ đề: {0}", "Cập nhật màu chủ đề thất bại. Đã lưu chế độ giao diện.",
