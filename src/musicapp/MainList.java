        ...
        this.mLoaDataThread = new Thread(new Runnable() {
            public void run() {
                ...
                if (cateItems == null) {
                    ...
                    MainList.displayMessage("NhacCuaTui", "Chưa có dữ liệu!", "error", MainList.this.observer,
                            MainList.this);
                } else {
        ...
        this.mLoaDataThread = new Thread(new Runnable() {
            public void run() {
                ...
                if (playlistItems == null) {
                    ...
                    PlaylistList playlistList = new PlaylistList("Playlist New", playlistItems, "new", "");
                    playlistList.setObserver(MainList.this.observer);
                    MainList.this.observer.replaceCurrent(playlistList);
                }
            }
    ...
    private void itemAction() {
        ...
        switch (selectedItem) {
            case 0:
                ...
                break;
            case 1:
                displayMessage("NhacCuaTui", "Đang tải dữ liệu...", "loading", this.observer, this);
                this.gotoCate();
                break;
            case 2:
                displayMessage("NhacCuaTui", "Đang tải dữ liệu...", "loading", this.observer, this);
