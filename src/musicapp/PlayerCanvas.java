...
import musicapp.common.ConvertMessage;
import musicapp.common.LikeOberserver;
import musicapp.common.LikePlaylist;
...
public class PlayerCanvas extends Canvas implements CommandListener, LikeOberserver, LoadDataObserver {
    ...
    private void doLike() {
        MainList.displayMessage("NhacCuaTui", "Đang tải dữ liệu...", "loading", this.observer, this);
        ...
        if (!this.userName.equals("")) {
            ...
            MainList.displayMessage("NhacCuaTui",
                    "Bạn chưa đăng nhập.  Xin vui lòng đăng nhập để thực hiện chức năng này", "error", this.observer, this);
        }
    ...
    public void likeComplete(String result) {
        MainList.displayMessage("NhacCuaTui", ConvertMessage.convertLikeMessage(result), "error", this.observer,
                this);
    }
