...
public class StringUtils {
  ...
  public static String replace(String text, String searchString, String replacementString) {
    if (text == null || searchString == null || replacementString == null) {
      return text;
    }
    ...
    StringBuffer buffer = getStringBuffer(text.length() + 50);
    try {
      ...
      while (searchStringPosition != -1) {
        buffer
            .append(text.substring(startPosition, searchStringPosition))
      ...
      buffer.append(text.substring(startPosition));
