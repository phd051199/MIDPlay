...
public class Lang {
  ...
  static {
    ...
    langEn.put("album", "Album");
    langEn.put("discover_playlists", "Discover Playlists");
    langEn.put("favorites", "Favorites");
    langEn.put("playlist", "Playlist");
    langEn.put("search", "Search");
    langEn.put("settings", "Settings");
    langEn.put("track", "Track");
    ...
    langTr.put("playlist.error.cannot_rename_system", "Cannot rename system playlists");
    ...
    langTr.put("about", "Hakkında");
    langTr.put("album", "Albüm");
    langTr.put("discover_playlists", "Çalma Listelerini Keşfet");
    langTr.put("favorites", "Favoriler");
    langTr.put("playlist", "Çalma Listesi");
    langTr.put("search", "Arama");
    langTr.put("settings", "Ayarlar");
    langTr.put("track", "Şarkı");
    ...
    langVi.put("app.about", "Giới thiệu");
    ...
    langVi.put("playlist.error.cannot_rename_system", "Cannot rename system playlists");
    ...
    langVi.put("about", "Giới thiệu");
    langVi.put("album", "Album");
    langVi.put("discover_playlists", "Khám phá playlist");
    langVi.put("favorites", "Yêu thích");
    langVi.put("playlist", "Playlist");
    langVi.put("search", "Tìm kiếm");
    langVi.put("settings", "Cài đặt");
    langVi.put("track", "Bài hát");
