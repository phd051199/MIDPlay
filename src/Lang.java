...
public class Lang {
  ...
  private static final String[] KEYS = {
    ...
    "search.error.empty_keyword", "search.placeholder", "search.results",
        ...
        "settings.theme_mode",
    "settings.theme_color", "settings.theme_mode_options.dark", "settings.theme_mode_options.light",
    ...
    "time.error.invalid_duration", "time.error.invalid_format", "time.minutes", "timer.action",
        "timer.actions.exit_app", "timer.actions.stop_playback", "timer.cancel",
        "timer.confirm.exit", "timer.set", "timer.sleep_timer",
    "timer.status.cancelled", "timer.status.expired", "timer.status.remaining", "timer.status.set",
  ...
  private static final String[] HE_VALS = {
    ...
    "צבע ערכת הנושא", "כהלום", "בהיר", "שיטת נגינה", "העבר Input Stream",
