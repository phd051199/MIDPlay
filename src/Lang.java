...
public class Lang {
  ...
  private static final String[] EN_VALS = {
    ...
    "Stop", "Volume", "Add to Playlist", "Create Playlist",
        "This playlist is not empty. Delete all?",
    ...
    "Search Type", "Audio Quality", "Automatic Updates", "Check for Updates", "Appearance",
    "Dark", "Light", "Player Method", "Pass Input Stream", "Pass URL",
    "Failed to save settings", "Language",
        "Select an item to move, then select the destination position", "Order saved", "Service",
    "Settings saved successfully", "Select items to hide/show. [x] = show, [] = hide",
  ...
  private static final String[] HE_VALS = {
    ...
    "סוג חיפוש", "איכות שמע", "עדכון אוטומטי", "בדוק עדכונים זמינים", "ערכת נושא",
    "כהלום", "בהיר", "שיטת נגינה", "העבר Input Stream", "העבר URL",
    "שמירת ההגדרות נכשלה", "Language/שפה", "בחר פריט להעביר, ואז בחר במיקום היעד", "הסידור נשמר",
        "שירות מוזיקה",
    "ההגדרות נשמרו בהצלחה", "בחר פריט להציג או להסתיר. [x] = מוצג, [] = מוסתר",
  ...
  private static final String[] TR_VALS = {
    ...
    "Ayarlar kaydedilemedi", "Dil", "Taşınacak öğeyi seçin, sonra hedef konumu seçin",
        "Sıralama kaydedildi", "Servis",
    "Ayarlar başarıyla kaydedildi", "Gizle/göster öğeleri seçin. [x] = göster, [] = gizle",
  ...
  private static final String[] VI_VALS = {
    ...
    "Dừng", "Âm lượng", "Thêm vào playlist", "Tạo playlist",
        "Playlist này có chứa bài hát. Xóa tất cả?",
    ...
    "Loại tìm kiếm", "Chất lượng âm thanh", "Tự động cập nhật", "Kiểm tra cập nhật", "Giao diện",
    "Tối", "Sáng", "Phương thức phát", "Truyền Input Stream", "Truyền URL",
    "Lỗi lưu cài đặt", "Ngôn ngữ", "Chọn mục để di chuyển, sau đó chọn vị trí đích",
        "Đã lưu thứ tự", "Dịch vụ",
    "Lưu cài đặt thành công", "Chọn mục để ẩn/hiện. [x] = hiện, [] = ẩn", "Đã lưu cài đặt hiển thị",
