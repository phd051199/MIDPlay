...
public final class PlayerScreen extends Canvas
    ...
    private void handleAction(int action) {
        ...
        try {
            if (volumeAlertShowing) {
                // The Up and Down keys are now adjusting the volume also when the alert is shown, to allow the user to click the up/down key a few times instead of up/down and then right/left
                switch (action) {
                    case Canvas.UP:
